...
async function main() {
  ...
  // ═══════════════════════════════════════════════════════════════════════════
    ...
    // ─── REMESSA PARA VENDA FORA DO ESTABELECIMENTO ─────────────────────────
    {
      ...
      ipiApplicable: false,
      priority: 10,
      naturezaOperacao: 'Remessa para Venda Fora do Estabelecimento',
      cfopEntradaVinculado: '1.904',
      geraCredito: false,
      temST: false,
      observation: 'Remessa de mercadoria para venda fora do estabelecimento (feiras, vendedor externo).',
      informacoesComplementares: 'Remessa para venda fora do estabelecimento. Documento emitido por ME ou EPP optante pelo Simples Nacional.',
      baseLegal: 'LC 123/2006. CSOSN 900. NT 2024.001 — CFOP permitido para MEI.',
      mensagemAlerta: 'Emitir NF de retorno (CFOP 1.904) para mercadorias não vendidas.',
    },
